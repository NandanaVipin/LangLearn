...
const EBooksPage = () => (
  <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white py-16">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Spanish Books */}
      <div className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-8">Spanish E-Books</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            {
              title: "Complete Spanish Guide 2024",
              level: "Beginner to Intermediate",
              pages: "450 pages",
              format: "PDF & EPUB",
              price: "$24.99",
              description: "Comprehensive guide covering all aspects of Spanish language"
            },
            {
              ...
              format: "PDF & EPUB",
              price: "$29.99",
              description: "Professional Spanish for business contexts"
            },
            {
              title: "Spanish Conversation Master",
              level: "Intermediate",
              pages: "320 pages",
              format: "PDF & Audio",
              price: "$19.99",
              description: "Master everyday Spanish conversations"
            }
          ].map((book) => (
            <motion.div
              key={book.title}
      ...
      {/* French Books */}
      <div className="mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-8">French E-Books</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            {
              ...
              format: "PDF & EPUB",
              price: "$34.99",
              description: "Complete French language learning guide"
            },
            {
              ...
              format: "PDF & EPUB",
              price: "$27.99",
              description: "Learn French through cultural insights"
            },
            {
              ...
              format: "PDF",
              price: "$22.99",
              description: "Comprehensive French grammar reference"
            }
          ].map((book) => (
            <motion.div
              key={book.title}
      ...
      {/* Japanese Books */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-8">Japanese E-Books</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            {
            ...
            {
              title: "Kanji Master Guide",
              level: "Intermediate to Advanced",
              pages: "600 pages",
              format: "PDF & Practice Sheets",
              price: "$39.99",
              description: "Master 2000+ Kanji characters"
            },
            {
              title: "Japanese Conversation Skills",
              level: "All Levels",
              pages: "320 pages",
              format: "PDF & Audio",
              price: "$29.99",
              description: "Natural Japanese conversation practice"
            }
          ].map((book) => (
            <motion.div
              key={book.title}
...
const LanguageLearningPage = () => {
  ...
  const languageResources: Record<string, LanguageContent> = {
    Spanish: {
      beginner: [
